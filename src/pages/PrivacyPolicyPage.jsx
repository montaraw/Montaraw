          ...
          <section className="space-y-2.5">
            ...
            <div className="p-4 bg-[#181818] border border-white/15 rounded-2xl mt-2 text-xs">
              ...
              <p className="text-gray-300">
                Primary Helpline: <a href="tel:+919720538576" className="text-white hover:text-brand-red font-bold underline transition-colors">+91 97205 38576</a> | Secondary: <a href="tel:+916206424372" className="text-gray-300 hover:text-white underline transition-colors">+91 62064 24372</a>
              </p>
